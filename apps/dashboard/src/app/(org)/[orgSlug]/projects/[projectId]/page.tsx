...
export default function ProjectDetailPage() {
  ...
  return <div className="space-y-6 p-6">
    ...
    <div className="flex flex-wrap gap-2"><Button variant="outline" onClick={() => router.push(`/${orgSlug}/applications`)}>Anwendungen verwalten</Button><Button variant="outline" onClick={() => router.push(`/${orgSlug}/projects/${projectId}/domains`)}>Domains verwalten</Button><Button variant="outline" onClick={() => router.push(`/${orgSlug}/projects/${projectId}/environments`)}>Umgebungen verwalten</Button><Button variant="outline" onClick={() => router.push(`/${orgSlug}/projects/${projectId}/settings/general`)}>Projekt bearbeiten</Button><Button disabled className="gap-2"><Rocket className="size-3.5" />Deployment geplant</Button></div>
  </div>;
}
