...
export default function TeamProjectsPage() {
  ...
  const projects = useQuery<Project[]>({ queryKey: ["orgs", orgSlug, "projects"], queryFn: async () => { const r = await fetch(api(`/organizations/${orgSlug}/projects`), { credentials: "include" }); if (!r.ok) throw new Error("Projekte konnten nicht geladen werden"); return (await r.json()).items as Project[]; } });
